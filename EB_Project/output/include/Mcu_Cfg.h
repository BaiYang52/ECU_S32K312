...
*/
#define MCU_MAX_NUMBER_OF_PARTITIONS         ((uint8)2U)
...
/**
* @brief           This define controls the availability of function Power_Ip_EnableLastMile and Power_Ip_DisableLastMile
*/
