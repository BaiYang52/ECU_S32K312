...
#define CANIF_UPCONFIRMTXPDU_MAX_NUMBER 1u
#define CANIF_UPCONFIRMTXPDU_NUMBER_PARTITION0 1u

#define CANIF_TXBYTEBUFFER_MAX_NUMBER 32u
#define CANIF_TXBYTEBUFFER_NUMBER_PARTITION0 32u

#define CANIF_TXPDUBUFFER_MAX_NUMBER 4u
#define CANIF_TXPDUBUFFER_NUMBER_PARTITION0 4u

#define CANIF_TXBUFFER_MAX_NUMBER 1u
#define CANIF_TXBUFFER_NUMBER_PARTITION0 1u
...
#define CANIF_CTRLRUNTIME_MAX_NUMBER 1u
#define CANIF_CTRLRUNTIME_NUMBER_PARTITION0 1u
...
#define CANIF_TXBUFFER_CONFIG_MAX_NUMBER 1u
#define CANIF_TXBUFFER_CONFIG_NUMBER_PARTITION0 1u
