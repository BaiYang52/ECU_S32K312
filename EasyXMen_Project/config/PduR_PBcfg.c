...
static const PduR_DestPduType PduR_DestPduConfigData[PDUR_DEST_PDU_SUM] =
{
    ...
    },
    {
        ...
        ComConf_ComIPdu_ComIPdu_0x12a_Rx,  /* PduRDestModulePduIndex */
        8u,    /* ConfiguredLength */
...
{
    {
        ...
        PDUR_COM,    /* BswModuleIndex */
        ComConf_ComIPdu_ComIPdu_0x110_Tx,    /* PduRSrcModulePduIndex */
    },
    {
        /* 1 PduRSrcPdu_0x12a_Rx */
        TRUE, /* PduRSrcPduUpTxConf */
        PDUR_CANIF,    /* BswModuleIndex */
        CanIfConf_CanIfRxPduCfg_CanIfRxPduCfg_012a,    /* PduRSrcModulePduIndex */
    },
};
