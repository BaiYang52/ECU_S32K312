...
//  * @file        : 3.0.0
//  * @licence     : 
//  * @date        : PduR MemMap Header
//  * @customer    : 
//  * @description : PduR_MemMap.h
...
// __attribute__((section("CODE.GLOBAL.PDUR.UNSPECIFIED")))
...
// __attribute__((section("VAR_INIT.GLOBAL.PDUR.UNSPECIFIED")))
...
// /*Index:2  Section name : VAR_INIT_PTR*/
...
// /*Index:3  Section name : VAR_INIT_UNSPECIFIED*/
...
// __attribute__((section("VAR_CLEARED.GLOBAL.PDUR.UNSPECIFIED")))
...
// /*Index:6  Section name : VAR_CLEARED_16*/
...
// #error "PduR_MemMap.h, section is used consecutively many times."
// #endif
// #define PDUR_START_SEC_VAR_CLEARED_16_NO_MATCH
// __attribute__((section("VAR_CLEARED.GLOBAL.PDUR.UNSPECIFIED")))

// #elif defined PDUR_STOP_SEC_VAR_CLEARED_16
// #undef PDUR_STOP_SEC_VAR_CLEARED_16
// #undef MEMMAP_ERROR
// #ifdef PDUR_START_SEC_VAR_CLEARED_16_NO_MATCH
// #undef PDUR_START_SEC_VAR_CLEARED_16_NO_MATCH
// #else
// #error "PduR_MemMap.h, no matching section was used."
// #endif
// #ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
// /*Index:7  Section name : VAR_CLEARED_32*/
...
// #error "PduR_MemMap.h, section is used consecutively many times."
// #endif
// #define PDUR_START_SEC_VAR_CLEARED_32_NO_MATCH
// __attribute__((section("VAR_CLEARED.GLOBAL.PDUR.UNSPECIFIED")))

// #elif defined PDUR_STOP_SEC_VAR_CLEARED_32
// #undef PDUR_STOP_SEC_VAR_CLEARED_32
// #undef MEMMAP_ERROR
// #ifdef PDUR_START_SEC_VAR_CLEARED_32_NO_MATCH
// #undef PDUR_START_SEC_VAR_CLEARED_32_NO_MATCH
// #else
// #error "PduR_MemMap.h, no matching section was used."
// #endif
// #ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
// /*Index:8  Section name : VAR_CLEARED_PTR*/
...
// /*Index:9  Section name : VAR_CLEARED_UNSPECIFIED*/
...
// #error "PduR_MemMap.h, section is used consecutively many times."
// #endif
// #define PDUR_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
// __attribute__((section("VAR_CLEARED.GLOBAL.PDUR.UNSPECIFIED")))

// #elif defined PDUR_STOP_SEC_VAR_CLEARED_UNSPECIFIED
// #undef PDUR_STOP_SEC_VAR_CLEARED_UNSPECIFIED
// #undef MEMMAP_ERROR
// #ifdef PDUR_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
// #undef PDUR_START_SEC_VAR_CLEARED_UNSPECIFIED_NO_MATCH
// #else
// #error "PduR_MemMap.h, no matching section was used."
// #endif
// #ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
// /*Index:10  Section name : CONFIG_DATA_8*/
...
// #error "PduR_MemMap.h, section is used consecutively many times."
// #endif
// #define PDUR_START_SEC_CONFIG_DATA_8_NO_MATCH
// __attribute__((section("CONFIG_DATA.GLOBAL.PDUR.UNSPECIFIED")))

// #elif defined PDUR_STOP_SEC_CONFIG_DATA_8
// #undef PDUR_STOP_SEC_CONFIG_DATA_8
// #undef MEMMAP_ERROR
// #ifdef PDUR_START_SEC_CONFIG_DATA_8_NO_MATCH
// #undef PDUR_START_SEC_CONFIG_DATA_8_NO_MATCH
// #else
// #error "PduR_MemMap.h, no matching section was used."
// #endif
// #ifdef MEMMAP_ERROR_SEC_NO_MATCH
...
// /*Index:11  Section name : CONFIG_DATA_16*/
