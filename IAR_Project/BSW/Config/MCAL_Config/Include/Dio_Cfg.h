...
/**
* @brief          Symbolic name for the port DioPort_PTA_L.
*
*/
#define DioConf_DioPort_DioPort_PTA_L  ((uint8)0x00U)
...
*
*/
#define  DioConf_DioChannel_DioChannel_0 ((uint16)0x0000U)

/* ---------- DioPort_PTA_H ---------- */

/**
* @brief          Symbolic name for the port DioPort_PTA_H.
*
*/
#define DioConf_DioPort_DioPort_PTA_H  ((uint8)0x01U)

/* ---------- DioPort_PTB_L ---------- */

/**
* @brief          Symbolic name for the port DioPort_PTB_L.
*
*/
#define DioConf_DioPort_DioPort_PTB_L  ((uint8)0x02U)



/**
* @brief          Symbolic name for the channel DioChannel_PB10.
*
*/
...
/**
* @brief          Symbolic name for the port DioPort_PTB_H.
*
*/
#define DioConf_DioPort_DioPort_PTB_H  ((uint8)0x03U)

/* ---------- DioPort_PTC_L ---------- */

/**
* @brief          Symbolic name for the port DioPort_PTC_L.
*
*/
#define DioConf_DioPort_DioPort_PTC_L  ((uint8)0x04U)

/* ---------- DioPort_PTC_H ---------- */

/**
* @brief          Symbolic name for the port DioPort_PTC_H.
*
*/
#define DioConf_DioPort_DioPort_PTC_H  ((uint8)0x05U)

/* ---------- DioPort_PTD_L ---------- */

/**
* @brief          Symbolic name for the port DioPort_PTD_L.
*
*/
#define DioConf_DioPort_DioPort_PTD_L  ((uint8)0x06U)

/* ---------- DioPort_PTD_H ---------- */

/**
* @brief          Symbolic name for the port DioPort_PTD_H.
*
*/
#define DioConf_DioPort_DioPort_PTD_H  ((uint8)0x07U)

/* ---------- DioPort_PTE_L ---------- */

/**
* @brief          Symbolic name for the port DioPort_PTE_L.
*
*/
#define DioConf_DioPort_DioPort_PTE_L  ((uint8)0x08U)

/* ---------- DioPort_PTE_H ---------- */

/**
* @brief          Symbolic name for the port DioPort_PTE_H.
*
*/
#define DioConf_DioPort_DioPort_PTE_H  ((uint8)0x09U)
