...
#define DMA_IP_TYPES_SW_MAJOR_VERSION                4
...
typedef struct
{
    ...
    const uint8 pMultiCoreDmaChannelConfig[DMA_IP_DMA_TOTAL_NOF_LOGIC_CHANNEL];
    const uint8 pMultiCoreDmaInstanceConfig[DMA_IP_DMA_TOTAL_NOF_LOGIC_INST];
