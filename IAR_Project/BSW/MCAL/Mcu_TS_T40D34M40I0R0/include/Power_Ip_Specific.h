...
#define DCM_GPR_DCMRWF2_RWBITS_MASK                 (((uint32)DCM_GPR_DCMRWF2_SIRC_TRIM_BYP_STDBY_EXT_MASK | \
...
#define MC_ME_PRTN0_COFB1_CLKEN_REQ43(x)         (((uint32_t)(((uint32_t)(x)) << MC_ME_PRTN0_COFB1_CLKEN_REQ43_SHIFT)) & MC_ME_PRTN0_COFB1_CLKEN_REQ43_MASK)
...
typedef enum
{
    ...
    MCU_F_EXR_RESET = McuConf_McuResetReasonConf_MCU_F_EXR_RESET,                               /**< @brief Software destructive reset. RGM_FES[F_FR0]. */
